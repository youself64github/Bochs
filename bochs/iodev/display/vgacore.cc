...
void bx_vgacore_c::init(void)
{
  ...
  Bit32u ips = SIM->get_param_num("ips")->get();
  BX_VGA_THIS vgafrequency_hz = SIM->get_param_num("vga_core_freq", base)->get();
  BX_VGA_THIS vgalatency_ticks = (Bit32u) (ips / (Bit32u(vgafrequency_hz) * 1));
