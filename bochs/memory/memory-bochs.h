...
protected:
  ...
  Bit32u  frequency_khz; // emulated memory speed frequency
...
public:
  ...
  BX_MEM_SMF void    init_memory(Bit64u guest, Bit64u host, Bit32u block_size, Bit32u frequency_khz, Bit64u ips);
